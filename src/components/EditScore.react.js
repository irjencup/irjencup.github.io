...
import ScorerList from './ScorerList.react'
    ...
    <hr/>
      <div className="row">
        <div className="col-md-3">
          <PlayerList team={match.team1} onSelectPlayer={this._onSelectPlayer.bind(this, 'team1')} />
        </div>
        ...
        <div className="col-md-2">
          <button onClick={this._addGoal.bind(this, 'team2')} className="btn btn-primary btn-sm">Tambah Gol</button>
        </div>
      </div>
      <hr/>
