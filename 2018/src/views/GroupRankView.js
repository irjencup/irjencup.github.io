            ...
            <table className="table table-bordered" style={{background: "rgba(0,0,0,0.5)", border: "0px", color: "#fff"}}>
              <thead>
                <tr style={{ background: "rgba(0,0,0,0.5)", color: "#fff" }}>
                  ...
                  <th
                    style={{ textAlign: "center", background: 'rgba(0,0,0,0.5)' }}
                  >
                    selisih
                  </th>
                  <th style={{ background: "rgba(0,0,0,0.5)" }}>gol</th>
                  <th style={{background: "rgba(0,0,0,0.5)"}}>bobol</th>
                  <th />
              ...
              <tbody>
                {teams.map((team, index) => {
                  return <tr key={index} style={team.group !== "3" && index < 3 ? { background: "rgba(144, 238, 144, 0.5)" } : (team.group == "3" && index < 2) ? {background: 'rgba(144,238,144,0.5)'}: {}}>
