  ...
  render() {
    ...
    return (<div>
      ...
      >
            ...
            return <li className="list-group-item" key={index} style={{ marginBottom: '10px' }}>
              <div className="row">
                ...
                <div className="col-xs-4" style={{ textAlign: 'right' }}>
                  <img height="50px" src={the_match.team1.logo_url} alt="logo tim" />
                  <br />
                ...
                <div className="col-xs-4">
                  <img height="50px" src={the_match.team2.logo_url} alt="logo tim" />
                  <br />
        ...
        <h2>Group 3</h2>
        <ul className="list-group">
          {this.state.groupc.map((the_match, index) => {
            return <li className="list-group-item" key={index} style={{ marginBottom: '10px' }}>
              <div className="row">
                <div className="col-md-2">
                  <span className="btn btn-xs btn-success">{the_match.date}</span>
